export class HueTintFXPipeline extends Phaser.Renderer.WebGL.Pipelines.SpriteFXPipeline {
  ...
  onDrawSprite(obj: Phaser.GameObjects.Sprite, _) {
    const hueTint = obj.getData("hueTint");
    const outline = obj.getData("outline");

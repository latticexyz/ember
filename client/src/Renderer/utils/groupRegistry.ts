...
import Settlement from "../objects/main/settlement";
...
export class GroupRegistry implements Service {
  ...
  public groups: {
    ...
    settlement: Phaser.GameObjects.Group;
  ...
  bootService(scene: MainScene) {
    ...
    this.groups = {
      ...
      settlement: this.scene.add.group(),
    ...
    this.groups.settlement.classType = Settlement;

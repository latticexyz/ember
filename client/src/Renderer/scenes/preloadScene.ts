...
export default class PreloadScene extends Phaser.Scene {
  ...
  async preload() {
    ...
    this.load.multiatlas("heroes", "Assets/multiatlas/Heroes.json", "Assets/multiatlas");
    this.load.multiatlas("atlas", "Assets/multiatlas/atlas.json", "Assets/multiatlas");
    ...
    this.load.spritesheet("digits", "Assets/spritesheets/Digits.png", {
      frameWidth: 5,
      frameHeight: 5,
    });

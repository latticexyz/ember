...
export class PhaserManager implements RequiresServices, RequiresObjects {
    ...
    constructor() {
        ...
        const settlementManager = new SettlementManager(groupRegistry, viewportObjectManager);
    ...
    boot(scene: MainScene) {
        ...
        this.services.settlementManager.bootService(scene);
    }
    ...
    destroy() {
        ...
        this.services.settlementManager.destroyService();

...
import { creatureToReactSpritesheet } from "../../Frontend/Components/Windows/SummonCreatures/constants";
  ...
  handleSetCamera(cameraNum: number) {
    ...
    if (this.selection.hasSelectedCreatures) {
      ...
      if (creatureIds) {
        ...
        if (creature) {
          const sprite = creatureToReactSpritesheet[creature.species][creature.creatureType];

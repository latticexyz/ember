...
export interface DungeonEvents {
  ...
  [DungeonEvent.SettlementUpdated]: (settlement: Settlement, regionCoord: WorldCoord) => void;
...
export interface DungeonFacetEventHandlers {
  ...
  [DungeonFacetEvent.SettlementUpdated]: ContractEventHandler<SettlementUpdatedParams>;

import { BankFacet, ConfigFacet, CreaturesFacet, DungeonFacet, GetterFacet, SettlementFacet } from "../../typechain";
...
const createContractsWithConnector = (
  ...
  const settlementFacetABI = contractABI.SettlementFacet.abi as any;
  ...
  const settlementFacet = new Contract(diamondAddress, settlementFacetABI, connector) as SettlementFacet;
...
export const ARBITRUM_TX_OVERRIDES: TxOverrides<TxType> = {
  ...
  [TxType.CreateSettlement]: { gasLimit: 10_000_000 }, // TODO: is this the right value?
};
...
const DEV_TX_OVERRIDES: TxOverrides<TxType> = {
  ...
  [TxType.ClaimDungeonHeart]: {},
  [TxType.CreateSettlement]: { gasLimit: 10_000_000 },
};
...
export const OE_TX_OVERRIDES: TxOverrides<TxType> = {
  ...
  [TxType.CreateSettlement]: { gasLimit: 10_000_000 }, // TODO: is this the right value?
  [TxType.UpgradeSettlement]: { gasLimit: 10_000_000 },  // TODO: is this the right value?
};

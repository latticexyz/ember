...
export interface GameConstants {
  ...
  MAX_MANA: number;
  MANA_PER_ACTION_TYPE: [number, number];

  SETTLEMENT_PRICE_PER_LEVEL: [[number, number], [number, number], [number, number]];
  SETTLEMENT_PRICE_PERCENT_INCREASE_PER_UNIT: [number, number, number, number];
  NUMBER_OF_SECONDS_FOR_ONE_ENERGY_REGEN: number;
  MAX_ENERGY_PER_LEVEL: [number, number, number];
  ...
  WALL_PRICE: number;
  TILE_UPGRADE_PRICES: [number, number, number, number, number, number, number, number];
  TILE_UPGRADE_PRICE_PERCENT_INCREASE_PER_UNIT: [number, number, number, number, number, number, number, number];
  INFLUENCE_PER_TILE_UPGRADE: [number, number, number, number, number, number, number, number];

  TILE_UPGRADE_GOLD_STORAGE: [number, number, number];
  TILE_UPGRADE_SOUL_STORAGE: [number, number, number];

  POPULATION_PER_LAIR: number;
  POPULATION_PER_DH: number;

  HARVEST_BOOST_TRANCHES: [number, number, number, number];
  TILE_UPGRADE_MAX_HARVEST: [number, number, number, number, number, number, number, number];
  TILE_UPGRADE_NUMBER_OF_SECONDS_FOR_ONE_HARVEST: [number, number, number, number, number, number, number, number];
  ...
  // CreatureSpecies -> CreatureType -> 3 upgrades
  CREATURES_LEVEL_UP_PRICE: [
    [
  ...
  // CreatureSpecies -> level -> ATK/LIFE -> value
  CREATURES_BASE_STAT_PER_SPECIES: [
  ...
  CREATURES_INFLUENCE_PER_SPECIES_AND_LEVEL: [[number, number, number, number], [number, number, number, number]];
  CREATURES_GROUP_MULTIPLIERS: [number, number, number, number, number];
  MAX_CREATURES_PER_SPECIES_AND_TYPES: [
    [number, number, number, number, number],
    [number, number, number, number, number]
  ];
...
interface GameConstantsUnparsed {
  ...
  SETTLEMENT_PRICE_PER_LEVEL: [[number, number], [number, number], [number, number]];
  SETTLEMENT_PRICE_PERCENT_INCREASE_PER_UNIT: [number, number, number, number];
  NUMBER_OF_SECONDS_FOR_ONE_ENERGY_REGEN: BigNumber;
  MAX_ENERGY_PER_LEVEL: [number, number, number];

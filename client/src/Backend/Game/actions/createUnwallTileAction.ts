...
import { CreatureSpecies } from "../../../_types/ContractTypes";
...
export const createUnwallTileAction: ActionCreator<CreateUnwallTileActionData, Action<WorldCoord[] | null>> = (
  ...
  const manaCost = type === ActionType.CompleteUnwallTile ? constants.gameConstants.MANA_PER_ACTION_TYPE[ContractActionType.MINE] : 0;

...
import { Settlement } from "../Windows/Settlement";
  ...
  return (
    <Container id={WINDOWS_CONTAINER_ID}>
      <MetaWindow defaultPosition={{ x: 0, y: 100 }} fadeIn={true} id="META_WINDOW_CONTAINER">
        ...
        {selectionManager && selectionManager.selectionIsDH && (
          <Window windowId="settlement" title="Settlement" component={<Settlement coord={selectionManager.selectedCoords[0]} />} />
        )}
        {selectionManager && selectionManager.selectionIsDH && (
          <Window

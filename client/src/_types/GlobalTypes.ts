...
export enum TxType {
  ...
  InitiateWallTile = "InitiateWallTile",
...
export enum GameManagerEvent {
  ...
  ClaimTileScheduled = "ClaimTileScheduled",
  ClaimTileStarted = "ClaimTileStarted",
  ClaimTileProofDone = "ClaimTileProofDone",
  ClaimTileTXSubmitted = "ClaimTileTXSubmitted",
  ClaimTileTXSubmitting = "ClaimTileTXSubmitting",
  ClaimTileTXConfirmed = "ClaimTileTXConfirmed",
  ClaimTileCancelled = "ClaimTileCancelled",
  ClaimTileFailed = "ClaimTileFailed",
